      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="prose prose-lg max-w-none">
          <p>
            ...
            www.organicaai.com website operated by Organica AI Solutions ("us", "we", or "our").
          </p>
          ...
          <p>
            ...
            exclusive property of Organica AI Solutions and its licensors. The Service is protected by 
          ...
          <p>
            ...
            by Organica AI Solutions.
          </p>
          
          <p>
            Organica AI Solutions has no control over, and assumes no responsibility for, the content, privacy 
            policies, or practices of any third-party websites or services. You further acknowledge and agree 
            that Organica AI Solutions shall not be responsible or liable, directly or indirectly, for any 
          ...
          <h2 className="text-2xl font-semibold text-gray-800 mt-8 mb-4">5. Termination</h2>
          <p>
          ...
          <p>
            In no event shall Organica AI Solutions, nor its directors, employees, partners, agents, suppliers, 
          ...
          <h2 className="text-2xl font-semibold text-gray-800 mt-8 mb-4">7. Disclaimer</h2>
          <p>
          ...
          <p>
            These Terms shall be governed and construed in accordance with the laws of Pennsylvania, United States, 
          ...
          <h2 className="text-2xl font-semibold text-gray-800 mt-8 mb-4">9. Changes</h2>
          <p>
